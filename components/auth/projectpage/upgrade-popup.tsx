...
export const UpgradePopup = () => {
  ...
  return (
    <div className="popupButton">
      ...
      >
        <span className="max-w-fit rounded-full border text-xs font-medium capitalize whitespace-nowrap bg-gradient-to-r from-violet-600 to-pink-600 text-white border-transparent px-3 py-1">
          Upgrade
        </span>
      </button>
      ...
      >
        <div
          className="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center z-50 bg-gray-100 bg-opacity-50 backdrop-blur-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
